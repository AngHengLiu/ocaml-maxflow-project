...
For example : 
```bash
./ftest.exe "./compatibility-graphs/graph2.txt" "3" "4" "../test2.txt"
```
**Warning**: In ftest.ml, please comment the test of the Ford-Fulkerson algorithm and decomment the test of the application of the algorithm on a bipartite matching problem under it to test it.
